...
class LdapAuth
{
    ...
    /* Configuration section: */
        private $serviceUser="cn=admin,dc=mega-lex,dc=ru";
        private $serviceSecret="Keeping-Cooler";
         ...
         */
        private $BaseDn="o=bd,dc=mega-lex,dc=ru"; //where are the users in the tree?
        private $UIDAttributeName="mail"; // what attribute you wanna search for the search & bind login? e.g. "mail" let users to login with their email address and password
